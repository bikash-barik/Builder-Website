    ...
    <>
      <div className="project">
        ...
        <div className="anim3 anim">
          ...
          <p style={{ color: "rgb(209, 205, 205)", letterSpacing:"0.1vw", fontSize: "1.2vw", marginTop: "3vw" }}>All our Projects are Well connected to provide all the convenience for living a luxury lifestyle.</p>
        </div>
      </div>
